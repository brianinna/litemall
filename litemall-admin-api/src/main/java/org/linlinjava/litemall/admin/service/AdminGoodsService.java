...
public class AdminGoodsService {
    ...
    public Object list(Integer cid,Integer goodsId, String goodsSn, String name,
                       Integer page, Integer limit, String sort, String order) {
        List<LitemallGoods> goodsList = goodsService.querySelective(cid,goodsId, goodsSn, name, page, limit, sort, order);
